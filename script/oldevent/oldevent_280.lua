--function oldevent_280()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(872,0,1);   --  1(1):[资差]说: 我到了冰火岛，只发现这撮*头发，却不见谢法王的人影*。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(873,9,0);   --  1(1):[张无忌]说: 我义父会到哪里去？会到哪*里去？一定是仇家把他害了*……
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(874,0,1);   --  1(1):[资差]说: 我看不会，冰火岛地处偏远*，你要不告诉我，我也很难*找到。而且岛上并没有打斗*的痕迹，我看多半是谢法王*自己离开了。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(875,9,0);   --  1(1):[张无忌]说: 我义父双目失明，是不会一*个人走的。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(876,0,1);   --  1(1):[资差]说: 那说不定是一个值得他信任*的人带他走的。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(880,0,1);   --  1(1):[资差]说: 紫杉龙王？她在哪里？
    instruct_0();   --  0(0)::空语句(清屏)
...
--end
    ...
    instruct_3(-2,111,0,0,0,0,0,0,0,0,-2,-2,-2);   --  3(3):修改事件定义:当前场景:场景事件编号 [111]
    instruct_3(-2,109,0,0,0,0,0,0,0,0,-2,-2,-2);   --  3(3):修改事件定义:当前场景:场景事件编号 [109]
    instruct_3(70,17,1,0,107,0,0,5284,5284,5284,-2,-2,-2);   --  3(3):修改事件定义:场景[资差居]:场景事件编号 [17]
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_13();   --  13(D):重新显示场景
--end
