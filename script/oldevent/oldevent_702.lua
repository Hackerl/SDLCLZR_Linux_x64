--function oldevent_702()
    ...
    if instruct_28(0,80,999,2,0) ==false then    --  28(1C):判断资差品德80-999是则跳转到:Label0
        instruct_0();   --  0(0)::空语句(清屏)
        do return; end
    end    --:Label0


    if instruct_29(0,0,100,2,0) ==false then    --  29(1D):判断资差武力0-100是则跳转到:Label1
        instruct_0();   --  0(0)::空语句(清屏)
        do return; end
    end    --:Label1
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2888,0,1);   --  1(1):[资差]说: 多谢玄慈大师。
    instruct_0();   --  0(0)::空语句(清屏)
