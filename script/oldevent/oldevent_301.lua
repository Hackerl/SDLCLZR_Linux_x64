--function oldevent_301()
    ...
    if instruct_60(-2,36,2286,0,935) ==true then    --  60(3C):判断场景-2事件位置36是否有贴图2286否则跳转到:Label2
        ...
        instruct_1(1024,0,1);   --  1(1):[资差]说: 咦？今天少林寺怎么这么大*阵势？难道是专门迎接我的*吗？
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1025,70,0);   --  1(1):[玄慈]说: 施主远道而来，不知有何见*教？
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1026,0,1);   --  1(1):[资差]说: 我……随便看看……*＜嘿嘿*，老和尚想不到吧，我是来*替明教报仇的，想把少林寺*夷为平地……＞
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1027,70,0);   --  1(1):[玄慈]说: 据老衲所知，施主此来是要*为明教报仇，想把少林寺夷*为平地。
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1028,0,1);   --  1(1):[资差]说: 你——！*＜谢法王和范右使怎么还没*到，要坏……＞
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1029,70,0);   --  1(1):[玄慈]说: 明教已然覆灭，阁下何必再*添杀戮。
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1030,0,1);   --  1(1):[资差]说: 谁说明教覆灭了，金毛狮王*谢逊和光明右使范遥还都在*呢。
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1035,0,1);   --  1(1):[资差]说: 谢法王，真的是你？
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1036,13,0);   --  1(1):[谢逊]说: 弟子罪孽深重，盼方丈收留*，赐予剃度。
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1037,0,1);   --  1(1):[资差]说: 啊？
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1044,0,1);   --  1(1):[资差]说: ＜糟糕糟糕，看来成昆老贼*的计划要泡汤，我得赶紧另*想出路……＞**谢法王，这，那，我要的*《倚天屠龙记》一书怎么办*啊？
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(1048,0,1);   --  1(1):[资差]说: 好，一言为定，我这就去找*成昆。
        instruct_0();   --  0(0)::空语句(清屏)
    ...
    if instruct_60(-2,37,2286,0,1815) ==true then    --  60(3C):判断场景-2事件位置37是否有贴图2286否则跳转到:Label4
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(2431,0,2);   --  1(1):[资差]说: 众人：*姓乔的，你杀了我的兄长，*血仇未曾得报，今日和你拼*了！
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(2432,0,2);   --  1(1):[资差]说: 众人：*这乔峰乃契丹胡虏，人人得*而诛之，今日可再也不能容*他或者走下少室山！
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_13();   --  13(D):重新显示场景
        instruct_1(2478,0,1);   --  1(1):[资差]说: 恩……他们竟然跑向了少林*的藏经阁，我得过去看看
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_14();   --  14(E):场景变黑
        ...
        instruct_1(2479,0,1);   --  1(1):[资差]说: ＜这老和尚是何方神圣？竟*然能降服萧远山和慕容博两*位老英雄？＞
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(2486,0,0);   --  1(1):[资差]说: 多谢大哥。不知大哥今后有*何打算？
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(2490,0,1);   --  1(1):[资差]说: 多谢大哥。大哥教诲，小弟*紧记在心。
        instruct_0();   --  0(0)::空语句(清屏)
