--function oldevent_428()
    ...
    instruct_1(1645,0,1);   --  1(1):[资差]说: 什么是太玄神功我不知道。*我来此只是想问一下，这里*有没有十四天书的下落。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1646,40,0);   --  1(1):[木岛主]说: 有！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1647,0,1);   --  1(1):[资差]说: 哦？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1648,39,0);   --  1(1):[龙岛主]说: 《侠客行》一书，就在侠客*岛！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1649,0,1);   --  1(1):[资差]说: 那，能不能把这本书送给我*？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1650,40,0);   --  1(1):[木岛主]说: 不可！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1651,39,0);   --  1(1):[龙岛主]说: 此书对侠客岛意义重大，只*要我兄弟二人还在，就绝不*允许别人拿走。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1652,0,1);   --  1(1):[资差]说: 哦，这么说只要灭了你们俩*就行了。
    instruct_0();   --  0(0)::空语句(清屏)
