--function oldevent_316()
    ...
    instruct_1(1127,0,1);   --  1(1):[资差]说: 姑娘是在叫我么？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1128,91,0);   --  1(1):[???]说: 当然是叫你！这还有别人么*？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1129,0,1);   --  1(1):[资差]说: 不知姑娘有何差遣？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1130,91,0);   --  1(1):[???]说: 你，陪我去华山。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1136,0,1);   --  1(1):[资差]说: 姑娘是想去华山游玩吗？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    if instruct_9(0,79) ==true then    --  9(9):是否要求加入?否则跳转到:Label0
        ...
        instruct_1(1132,0,1);   --  1(1):[资差]说: 好，在下愿陪姑娘走一遭。
        instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_1(1134,0,1);   --  1(1):[资差]说: 对不起，在下还有别的事。
