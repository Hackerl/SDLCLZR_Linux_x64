--function oldevent_890()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3545,0,1);   --  1(1):[资差]说: 你这男扮女装的老旦，*真令人恶心．
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3557,0,1);   --  1(1):[资差]说: 这话怎讲？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3559,0,1);   --  1(1):[资差]说: ＜原来当初任教主以”葵花*  宝典”传他，当初便没怀*  善意．＞*＜两人尔虞我诈各怀心机＞
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3560,0,2);   --  1(1):[资差]说: 任我行将那《葵花宝典》放*在双掌中一搓，功力到处，*原已十分陈旧的册页登时化*为碎片。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3561,0,1);   --  1(1):[资差]说: 这种害人东西，毁了最好。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3562,26,0);   --  1(1):[任我行]说: 小兄弟，这一役诛奸复位，*你实占首功．不如加入我日*月神教，我可以给你个副教*主做做，待我百年之后，这*教主的位置就是你的，如何*？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3563,0,1);   --  1(1):[资差]说: ＜区区一个教主，我很希罕*吗？＞任教主的好意，在下*心领了。我还要去寻找十四*天书，恕不能从命。告辞了*。
    instruct_0();   --  0(0)::空语句(清屏)
