--function oldevent_928()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3766,0,1);   --  1(1):[资差]说: 哦？我是一号吗？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    if instruct_28(0,50,999,16,0) ==false then    --  28(1C):判断资差品德50-999是则跳转到:Label18
    ...
    if instruct_28(0,50,999,0,16) ==true then    --  28(1C):判断资差品德50-999否则跳转到:Label20
    ...
    instruct_1(3795,0,1);   --  1(1):[资差]说: 呼～终于都解决了。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3796,256,0);   --  1(1):[???]说: 好，团体赛结束。现在我宣*布，本次大会的冠军是——**这小子！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3797,0,1);   --  1(1):[资差]说: ……怎么从头到尾都没人叫*我的名字啊……
    instruct_0();   --  0(0)::空语句(清屏)
