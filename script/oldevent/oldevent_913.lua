--function oldevent_913()
    ...
    instruct_1(3704,0,1);   --  1(1):[资差]说: 参见岳掌门。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3705,19,0);   --  1(1):[岳不群]说: 哦，少侠，是你啊，不知今*日来到华山，有何贵干？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3706,0,1);   --  1(1):[资差]说: 在下听说《笑傲江湖》一书*在岳掌门手中，可有此事？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3707,19,0);   --  1(1):[岳不群]说: 不错，此书就在我这。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3708,0,1);   --  1(1):[资差]说: 那可否将此书让与在下？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3709,19,0);   --  1(1):[岳不群]说: 可以！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3710,0,1);   --  1(1):[资差]说: 哇，岳先生如此慷慨大度，*真不愧君子剑的美名啊。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3711,19,0);   --  1(1):[岳不群]说: 少侠过奖。不过今日华山派*正遇到一个难题，还想请少*侠帮忙。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3712,0,1);   --  1(1):[资差]说: 无功不受禄，既然岳掌门答*应将《笑傲江湖》一书让与*在下，那在下也必会全力帮*主华山派。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3713,19,0);   --  1(1):[岳不群]说: 好。少侠可听说我五岳并派*之事？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3714,0,1);   --  1(1):[资差]说: 听说了一些，好像下个月十*五，要在嵩山开会吧？不知*嵩山派的左冷禅为何要急于*将五岳并派呢？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3715,0,1);   --  1(1):[资差]说: 那岳先生要在下怎么做，尽*管说吧。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3716,19,0);   --  1(1):[岳不群]说: 少侠需暂时加入我华山派，*在五岳并派之日，击败左冷*禅，粉碎他的阴谋。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3717,0,1);   --  1(1):[资差]说: 哈哈哈，我以华山弟子的名*义打败左冷禅，那这五岳剑*派掌门的位置可就落入岳先*生之手啦。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3718,19,0);   --  1(1):[岳不群]说: 小兄弟果然聪明，我岳不群*就喜欢和聪明人办事，怎么*样，能助我否？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3719,0,1);   --  1(1):[资差]说: 好，我就帮你这个忙，反正*我只想要天书，谁当五岳派*掌门与我无关。
    instruct_0();   --  0(0)::空语句(清屏)
