--function oldevent_996()
    ...
    instruct_1(3825,92,0);   --  1(1):[???]说: 你的，狡猾狡猾的。我们的*，相互支援的，不能！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3826,245,1);   --  1(1):[???]说: 哈哈哈，大胆倭人，敢来犯*我中华。今日就让你们知道*中国人的厉害。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3827,92,0);   --  1(1):[???]说: 你的，一个人的，对手的不*是！队员的，找好！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_30(32,35,32,42);   --  30(1E):主角走动32-35--32-42
    instruct_40(2);   --  40(28):改变主角站立方向2
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3828,0,1);   --  1(1):[资差]说: 大家都在摩拳擦掌，准备与*倭寇一决高下。我看这样吧*，每次由我来挑选队员，打*过一场的人就下去休息，下*一场战斗再从其他人中挑选*。这第一仗该选哪些人呢？
    instruct_0();   --  0(0)::空语句(清屏)
--end
