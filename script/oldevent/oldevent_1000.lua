--function oldevent_1000()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3834,0,1);   --  1(1):[资差]说: 好，众位齐心协力，倭寇不*堪一击。你！还有什么话说*？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3835,92,0);   --  1(1):[???]说: 中华，伟大的！*入侵，我们永远地不敢。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3838,0,1);   --  1(1):[资差]说: 对了，你们曾经说过，我来*自龙之国度，这龙之国度到*底在哪里呢？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_1(3841,0,1);   --  1(1):[资差]说: 每一位龙的传人，都应该以*国家的富强和民族的兴旺为*己任，巨龙正在苏醒，巨龙*终将腾飞！*我要走了，龙之国度正需要*我！
    instruct_0();   --  0(0)::空语句(清屏)
