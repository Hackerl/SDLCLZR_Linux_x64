--function oldevent_41()
    ...
    instruct_1(197,0,2);   --  1(1):[资差]说: "落~花~流~水~"
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(198,0,1);   --  1(1):[资差]说: 这里怎么这么热闹？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(206,0,1);   --  1(1):[资差]说: 〈书？难道是天书？〉
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    if instruct_5(0,198) ==true then    --  5(5):是否选择战斗？否则跳转到:Label0
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(210,0,1);   --  1(1):[资差]说: 喂，你刚才还正义凛然的，*现在怎么了？
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        if instruct_9(0,105) ==true then    --  9(9):是否要求加入?否则跳转到:Label2
            ...
            if instruct_20(30,0) ==false then    --  20(14):队伍是否满？是则跳转到:Label3
                ...
                instruct_0();   --  0(0)::空语句(清屏)
                instruct_1(215,0,1);   --  1(1):[资差]说: 废话少说，书在哪？
                instruct_0();   --  0(0)::空语句(清屏)
            ...
            instruct_0();   --  0(0)::空语句(清屏)
            instruct_3(70,41,1,0,141,0,0,7014,7014,7014,-2,-2,-2);   --  3(3):修改事件定义:场景[资差居]:场景事件编号 [41]
            instruct_17(-2,1,25,29,0);   --  17(11):修改场景贴图:当前场景层1坐标19-1D
            instruct_0();   --  0(0)::空语句(清屏)
            instruct_1(214,97,0);   --  1(1):[???]说: 小子，你还不赖嘛，加入我*血刀门吧！
            instruct_0();   --  0(0)::空语句(清屏)
