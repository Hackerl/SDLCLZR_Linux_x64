--function oldevent_898()
    ...
    instruct_1(3574,0,1);   --  1(1):[资差]说: 近日江湖盛传五岳剑派将在*下月十五，於嵩山召开大会*讨论并派之事．*不知岳先生对此有何看法．
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3576,0,1);   --  1(1):[资差]说: 岳先生人称”君子剑”，*果然名不虚传，*深具仁者之心．*武林中人只要都如岳先生这*般想法，天下的腥风血雨，*刀兵纷争，便都泯於无形了．
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3578,0,1);   --  1(1):[资差]说: 岳先生的见地，*定然是很高明的．
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3581,0,1);   --  1(1):[资差]说: 不知那嵩山派左掌门为何如*此急着要合并五岳剑派．
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3583,0,1);   --  1(1):[资差]说: 这种事情难办之极，左冷禅*的武功未必当世无敌，*他何以要花偌大心力？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3584,19,0);   --  1(1):[岳不群]说: 人心难测．世上之事，不论*多麽难办，总是有人要去试*上一试．*左冷禅若能灭了魔教，在武*林中已是唯我独尊之势，**再要吞并武当，收拾少林，*也未始不能．**干办这些大事，*那也不是全凭武功．
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3585,0,1);   --  1(1):[资差]说:  原来左冷禅是要天下武林之*士，个个遵他号令．
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3586,19,0);   --  1(1):[岳不群]说: 那时只怕他想做皇帝了，*做了皇帝之後，又想长生不*老，万寿无疆！*这叫”人心不足蛇吞象”，*自古以来，皆是如此．**英雄豪杰之士，绝少有人能*逃得过这”权位”的关口．
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3587,0,1);   --  1(1):[资差]说: 人生数十年，但贵适意，*却又何苦如此？**左冷禅要消灭崆峒，崑仑，*吞并少林，武当，不知将杀*多少人，流多少血？*岳先生，我们必须阻止左冷*禅，不让他野心得逞，以免*江湖之上，遍地血腥．
    instruct_0();   --  0(0)::空语句(清屏)
