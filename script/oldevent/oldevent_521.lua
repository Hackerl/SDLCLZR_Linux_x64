--function oldevent_521()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2211,0,1);   --  1(1):[资差]说: 你们是什么人，快放开段公*子。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_13();   --  13(D):重新显示场景
    instruct_1(2215,0,1);   --  1(1):[资差]说: 段公子，你没事吧？
    instruct_0();   --  0(0)::空语句(清屏)
