--function oldevent_505()
    ...
    instruct_1(2075,0,1);   --  1(1):[资差]说: 晚辈参见裘帮主
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2076,67,0);   --  1(1):[裘千仞]说: 你是谁，来此何干？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2077,0,1);   --  1(1):[资差]说: 是西域白驼山主人欧阳先生*叫我来的，他说来了您自然*知道。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2078,67,0);   --  1(1):[裘千仞]说: 哦，是欧阳先生啊，我知道*我知道。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2079,0,1);   --  1(1):[资差]说: ＜他的表情怎么这么奇怪？*＞
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2083,0,1);   --  1(1):[资差]说: 天下五绝，如雷贯耳。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2084,67,0);   --  1(1):[裘千仞]说: 我把铁掌功夫传授给你，你*去帮我杀了段皇爷
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2085,0,1);   --  1(1):[资差]说: 啊？这个，晚辈如何是段皇*爷的对手？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2086,67,0);   --  1(1):[裘千仞]说: 你放心，他现在应该已经内*力全失了，你只要能打发了*他的几个护卫就行了。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2087,0,1);   --  1(1):[资差]说: ＜又让我干这伤天害理的事*情，没办法，先学了铁掌再*说！＞
    instruct_0();   --  0(0)::空语句(清屏)
