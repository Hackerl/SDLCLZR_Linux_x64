--function oldevent_268()
    ...
    instruct_1(797,0,1);   --  1(1):[资差]说: 哇！这里这麽多人，干什麽*这麽热闹，可少不了小侠我*。我说名门正派又怎麽样，*还不是一样赶尽杀绝，跟魔*教又有什麽两样，只不过藉*口好听一点罢了。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(798,169,0);   --  1(1):[???]说: 少侠非魔教人士，*还请速速离去，*以免受池鱼之殃。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(799,0,1);   --  1(1):[资差]说: 那好，大家都别打了，因为*这中间着实有许多误会，*让我好好说给你们听。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(800,6,0);   --  1(1):[灭绝]说: 现在年轻人都这麽狂妄吗？*你自以为是武林盟主吗！*要我们听你说。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(801,8,0);   --  1(1):[唐文亮]说: 你这小贼，跟魔教勾结，*想要拖延时间，好施什麽诡*计麽？先杀了你再说。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(802,0,1);   --  1(1):[资差]说: 我就知道要你们安安静静听*我说是不太可能，那只有想*办法让你们服气了。*哪一派先来？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    if instruct_20(1511,0) ==false then    --  20(14):队伍是否满？是则跳转到:Label0
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(817,0,1);   --  1(1):[资差]说: 事情的经过是这样的。。。*如此如此。。。。。。。。*这般这般。。。。。。。。*总之，一切的阴谋，*都是成崑那奸贼所计划的。**所以我说呢，你们两方还是*握手言和吧，反正明教杀过*六大派的人，六大派也杀过*明教的人，大家半斤八两，*差不了多少，就都罢手吧。
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(825,0,1);   --  1(1):[资差]说: 快别这麽说，仗义行侠，本*就是我辈中人应当做的。
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(832,0,1);   --  1(1):[资差]说: 我这里有封阳教主的遗书，*上面提到要谢逊谢法王暂代*教主之职。
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(833,10,0);   --  1(1):[范遥]说: 可是谢法王至今杳无音信，*明教却不可一日无主啊。
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(834,9,0);   --  1(1):[张无忌]说: 我义父应该在冰火岛，咱们*去找他吧。
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(835,0,1);   --  1(1):[资差]说: 我倒有个主意。这位张公子*，今日也可算是明教的恩人*。他是鹰王的外孙，可算是*明教自己人。他还是狮王的*义子，就算狮王做了教主，*子继父业也是理所当然。而*且张公子似乎另有奇遇，武*功卓绝，这个明教教主，再*合适不过了。
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(846,0,2);   --  1(1):[资差]说: 明教众人：*        参见教主！
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_13();   --  13(D):重新显示场景
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(848,0,1);   --  1(1):[资差]说: 另外还有一件事拜托你们，*你们明教中是否有一本叫*《倚天屠龙记》的书？*是否能借我一下。
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(852,0,1);   --  1(1):[资差]说: 张公子，你知道你义父所在*吧，咱们去找他吧。
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(856,0,1);   --  1(1):[资差]说: 好，那我这就去寻找谢法王*。各位，告辞了。
        instruct_0();   --  0(0)::空语句(清屏)
