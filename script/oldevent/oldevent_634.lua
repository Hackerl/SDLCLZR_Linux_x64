--function oldevent_634()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_13();   --  13(D):重新显示场景
    instruct_1(2683,0,1);   --  1(1):[资差]说: 老婆婆，你没事吧？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2684,117,0);   --  1(1):[???]说: 臭小子，什么没事，老婆子*就要死啦！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2685,0,1);   --  1(1):[资差]说: 啊？这……这……
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2686,117,0);   --  1(1):[???]说: 不过那个贱人总算死在了我*前头，老婆子还得谢谢你啊*……*咦？你手上拿的是什么？*你怎么会有我们逍遥派的*掌门指环？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2687,0,1);   --  1(1):[资差]说: 这个是无崖子前辈给我兄弟*的，事情是这样的……
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_14();   --  14(E):场景变黑
    instruct_13();   --  13(D):重新显示场景
    instruct_1(2688,117,0);   --  1(1):[???]说: 师兄，师兄，你怎么在我之*前走了……
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2689,0,1);   --  1(1):[资差]说: 前辈原来是无崖子前辈的师*妹啊，那刚才那个女人是…*…？
    instruct_0();   --  0(0)::空语句(清屏)
