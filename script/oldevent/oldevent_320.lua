--function oldevent_320()
    ...
    if instruct_16(91,6,0) ==false then    --  16(10):队伍是否有[温青青]是则跳转到:Label0
        instruct_1(1149,0,1);   --  1(1):[资差]说: 这是温姑娘爹爹的遗物，温*姑娘想要这把剑……
    ...
    if instruct_29(0,70,1000,11,0) ==false then    --  29(1D):判断资差武力70-1000是则跳转到:Label1
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1147,0,1);   --  1(1):[资差]说: 终於让我给拔出来了！
    instruct_0();   --  0(0)::空语句(清屏)
