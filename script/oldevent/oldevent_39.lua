--function oldevent_39()
    ...
    instruct_1(179,0,1);   --  1(1):[资差]说: 你是谁，在这做什么？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(180,37,0);   --  1(1):[狄云]说: 唉，我叫狄云，是个不幸之*人。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(181,0,1);   --  1(1):[资差]说: 我要找些书，随便到这个山*洞来看看。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(182,37,0);   --  1(1):[狄云]说: 你还是早些离去的好，免得*被我这个不幸之人连累。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(183,0,1);   --  1(1):[资差]说: 你到底发生了什么事，说来*听听。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(185,0,1);   --  1(1):[资差]说: 你很爱你师妹，是吗？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(186,37,0);   --  1(1):[狄云]说: 我师妹怎能…………*怎能嫁给那个姓万的。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(187,0,1);   --  1(1):[资差]说: 那你后来怎么离开那荆州大*牢，又怎么会在这里？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(188,37,0);   --  1(1):[狄云]说: 在狱中的几年，同牢的丁典*丁大哥告诉了我许多江湖上*的事，也教了我"神照经"大*法。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(189,0,1);   --  1(1):[资差]说: 神照经？听起来很厉害的样*子……
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    if instruct_9(0,93) ==true then    --  9(9):是否要求加入?否则跳转到:Label0
        instruct_1(191,0,1);   --  1(1):[资差]说: 看你也无家可归，和我一起*走吧，路上也有个照应。
        instruct_0();   --  0(0)::空语句(清屏)

        if instruct_28(0,70,100,0,76) ==true then    --  28(1C):判断资差品德70-100否则跳转到:Label1
            ...
            instruct_0();   --  0(0)::空语句(清屏)
            instruct_3(70,7,1,0,125,0,0,5090,5090,5090,-2,-2,-2);   --  3(3):修改事件定义:场景[资差居]:场景事件编号 [7]
            instruct_3(70,8,1,0,125,0,0,5092,5092,5092,-2,-2,-2);   --  3(3):修改事件定义:场景[资差居]:场景事件编号 [8]
            do return; end
        end    --:Label1
    ...
    if instruct_5(0,47) ==true then    --  5(5):是否选择战斗？否则跳转到:Label3
        ...
        instruct_1(194,0,1);   --  1(1):[资差]说: 你说那个什么神照经，拿出*来看看啊
        instruct_0();   --  0(0)::空语句(清屏)
