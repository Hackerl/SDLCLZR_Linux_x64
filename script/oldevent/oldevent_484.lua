--function oldevent_484()
    ...
    if instruct_28(0,80,999,11,0) ==false then    --  28(1C):判断资差品德80-999是则跳转到:Label0
    ...
    instruct_3(70,13,1,0,147,0,0,6088,6088,6088,-2,-2,-2);   --  3(3):修改事件定义:场景[资差居]:场景事件编号 [13]
    instruct_3(70,14,1,0,149,0,0,6090,6090,6090,-2,-2,-2);   --  3(3):修改事件定义:场景[资差居]:场景事件编号 [14]
    instruct_0();   --  0(0)::空语句(清屏)
