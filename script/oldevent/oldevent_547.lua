--function oldevent_547()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2312,0,1);   --  1(1):[资差]说: 慕容公子此次不会再失信了*吧。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2316,0,1);   --  1(1):[资差]说: 你该不会是随便说说的吧。*人家称你们为“南慕容，北*乔峰”，你就说书在他那。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    if instruct_11(105,0) ==false then    --  11(B):是否住宿是则跳转到:Label1
        instruct_37(2);   --  37(25):增加道德2
        instruct_1(2330,0,1);   --  1(1):[资差]说: 慕容公子的好意，在下心领*了。但我不愿用卑鄙的方法*去得到那本《天龙八部》。
        instruct_0();   --  0(0)::空语句(清屏)
