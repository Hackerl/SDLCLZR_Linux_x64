--function oldevent_1062()
    ...
    instruct_1(3975,0,1);   --  1(1):[资差]说: 上回看你手中那把宝剑，*寒芒吞吐，电闪星飞，想必*就是传说中的”倚天剑”？*小侠我想向你借来用用．
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3976,6,0);   --  1(1):[灭绝]说: 光明顶上被你侥幸获胜，*你现在还敢来我峨嵋撒野，*莫非真视我峨嵋无人．
    instruct_0();   --  0(0)::空语句(清屏)

    if instruct_5(11,0) ==false then    --  5(5):是否选择战斗？是则跳转到:Label0
        instruct_1(3977,0,1);   --  1(1):[资差]说: 那里，那里．我只不过是来*劝师太，与明教间的事能和*就和．*自古以来冤家宜解不宜结．
        instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_1(3979,0,1);   --  1(1):[资差]说: 宝剑还是应该配英雄，*怎样？师太，这”倚天剑”*可以让给我了吧．
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3982,0,1);   --  1(1):[资差]说: 师太，师太！何苦如此呢？*若真不想给我，跟我说一声*就行了．唉！
    instruct_0();   --  0(0)::空语句(清屏)
