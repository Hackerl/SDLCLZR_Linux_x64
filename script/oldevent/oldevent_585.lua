--function oldevent_585()
    ...
    instruct_1(2530,0,1);   --  1(1):[资差]说: 乔峰，你看这是什麽？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2531,50,0);   --  1(1):[乔峰]说: 是什麽？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2532,0,0);   --  1(1):[资差]说: 你看了便知道。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2533,50,0);   --  1(1):[乔峰]说: 这……这是真的吗？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2534,0,1);   --  1(1):[资差]说: 少林方丈亲笔写的，会是假*的吗！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2535,51,0);   --  1(1):[慕容复]说: 我今日请来了智光大师、谭*公、谭婆、赵钱孙等人，他*们都可以作证。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2536,50,0);   --  1(1):[乔峰]说: 我……我……*我不是汉人…………*我是契丹人…………
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2537,0,1);   --  1(1):[资差]说: 乔峰，你是契丹人，非我族*类，其心必异，怎可担任这*丐帮帮主一职，保管《天龙*八部》一书呢！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2538,50,0);   --  1(1):[乔峰]说: 你要我怎麽做！
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2539,0,1);   --  1(1):[资差]说: 辞去丐帮帮主之位，*交出《天龙八部》一书。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2543,0,1);   --  1(1):[资差]说: 没什麽，这是中原武林的大*事，小弟应该做的。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2544,207,0);   --  1(1):[???]说: 但是，拜你所赐，我丐帮也*将因此事贻笑武林。你拿的*《天龙八部》是丐帮镇帮之*宝，还请阁下留下。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2545,0,1);   --  1(1):[资差]说: 怎麽可以，我好不容易才拿*到手的。
    instruct_0();   --  0(0)::空语句(清屏)
