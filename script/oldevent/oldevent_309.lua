--function oldevent_309()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1096,0,1);   --  1(1):[资差]说: ＜宋青书这小子倒是可以利*用，我是不是应该帮他一下*？＞
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_1(1086,0,1);   --  1(1):[资差]说: 这位公子恐怕是爱上了峨嵋*派的某位佳人，这也是人之*常情嘛，莫七侠何必苦苦相*逼？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1087,172,0);   --  1(1):[???]说: 这是我武当派自己的事，不*需旁人插手。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1088,82,0);   --  1(1):[???]说: 我不回去，我不回去，少侠*救我啊……
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1089,0,1);   --  1(1):[资差]说: 听到了吧，是他让我救他，*我也不得不管了。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1092,0,1);   --  1(1):[资差]说: 宋少侠，你亲手杀了你七叔*，这可是欺师灭祖的大罪啊*。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1093,82,0);   --  1(1):[???]说: 我不能再回武当了，不能再*回了，我该去哪？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(1094,0,1);   --  1(1):[资差]说: 跟着我吧，只要你好好帮我*，我就不会把这件事情说出*去的。
    instruct_0();   --  0(0)::空语句(清屏)
