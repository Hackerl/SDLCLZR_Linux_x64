--function oldevent_911()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3692,0,1);   --  1(1):[资差]说: 任教主、向大哥、令狐大哥*、任大小姐，你们怎么样？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3699,0,1);   --  1(1):[资差]说: 在下还要继续寻找十四天书*，加入神教之事万难从命。*还望任教主话复前言，告诉*我《笑傲江湖》一书的所在*。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3700,26,0);   --  1(1):[任我行]说: 哼！就算你得到了十四天书*，你也未必当的成武林盟主*。当武林盟主要靠实力的！**《笑傲江湖》一书，就在*岳不群手上。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3701,0,1);   --  1(1):[资差]说: 哦？此话当真？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3703,0,1);   --  1(1):[资差]说: 多谢了，我这就上华山！
    instruct_0();   --  0(0)::空语句(清屏)
