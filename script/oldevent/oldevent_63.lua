--function oldevent_63()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(278,0,1);   --  1(1):[资差]说: 什么啊？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(284,0,1);   --  1(1):[资差]说: 就是《鹿鼎记》一书。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(285,71,0);   --  1(1):[洪教主]说: 哦，还好，我这没有。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(286,0,1);   --  1(1):[资差]说: 那你这有什么书？
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(290,0,1);   --  1(1):[资差]说: 哼，打就打，谁怕谁。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_13();   --  13(D):重新显示场景
    instruct_1(295,0,1);   --  1(1):[资差]说: 这回不横了吧？还不把书拿*来。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    if instruct_43(228,0,143) ==true then    --  43(2B):是否有物品半部四十二章经否则跳转到:Label1
        ...
        instruct_1(305,0,1);   --  1(1):[资差]说: 又是半部《四十二章经》？*这下我正好可以凑成一部了*……
        instruct_0();   --  0(0)::空语句(清屏)
        ...
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(303,0,1);   --  1(1):[资差]说: 人都走了，还傻看什么，小*宝，咱们也走吧，这没有要*找的书了。
        instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(296,0,1);   --  1(1):[资差]说: 这是什么书？看你的样子一*定有问题，我先替你保管着*吧。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(297,225,1);   --  1(1):[???]说: 这位美女，啊不，教主夫人*，仙福永享，寿与天齐，那*个，你若没什么事，跟我们*一起走吧。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(298,71,0);   --  1(1):[洪教主]说: 你说什么！休打我夫人的主*意。
