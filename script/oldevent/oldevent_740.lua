--function oldevent_740()
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_13();   --  13(D):重新显示场景
    instruct_1(2932,0,1);   --  1(1):[资差]说: 看来对方来头不善，林兄弟*还是小心为是。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2935,0,1);   --  1(1):[资差]说: 刚才见二位剑法不凡，不知*是那一派门下，怎样称呼？
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2936,35,0);   --  1(1):[令狐冲]说: 在下华山令狐冲。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2937,79,0);   --  1(1):[???]说: 在下华山岳灵珊。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2938,0,1);   --  1(1):[资差]说: 华山派是名门大派，今日一*见果然名不虚传。
    instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(2941,0,1);   --  1(1):[资差]说: 后会有期
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_14();   --  14(E):场景变黑
