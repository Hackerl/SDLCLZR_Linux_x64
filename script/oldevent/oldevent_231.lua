--function oldevent_231()
    instruct_1(565,0,1);   --  1(1):[资差]说: 杨兄，龙姑娘，一切可好，*龙姑娘伤势如何了？
    ...
    instruct_3(70,19,1,0,151,0,0,6188,6188,6188,-2,-2,-2);   --  3(3):修改事件定义:场景[资差居]:场景事件编号 [19]
    instruct_3(70,20,1,0,153,0,0,6068,6068,6068,-2,-2,-2);   --  3(3):修改事件定义:场景[资差居]:场景事件编号 [20]
