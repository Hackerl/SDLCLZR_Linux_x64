--function oldevent_879()
    ...
    if instruct_11(23,0) ==false then    --  11(B):是否住宿是则跳转到:Label1
        instruct_1(3428,0,1);   --  1(1):[资差]说: 对不起，我可没那闲工夫！
        instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3432,0,1);   --  1(1):[资差]说: ＜不是吧？半年才攒了五两*银子？还不够我一次斗地主*的呢……我该收吗？＞
    instruct_0();   --  0(0)::空语句(清屏)

    if instruct_11(43,0) ==false then    --  11(B):是否住宿是则跳转到:Label2
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(3434,0,1);   --  1(1):[资差]说: ＜这么点钱，还不如不要呢*，干脆好人做到底吧。＞*大叔，我怎么能收您底钱呢，*这钱给孩子们买点书吧。
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(3435,201,0);   --  1(1):[???]说: 好人啊，你真是好人啊，我*为唱个曲吧。
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(3436,0,1);   --  1(1):[资差]说: 好啊。
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(3437,201,0);   --  1(1):[???]说: 青风相待，白云相爱。梦不*到紫罗袍共黄金带。一茅斋*，野花开，管甚谁家兴废谁*成败？陋巷单瓢亦乐哉。贫*，气如山！达，志如山！
        instruct_0();   --  0(0)::空语句(清屏)
        instruct_1(3438,0,1);   --  1(1):[资差]说: 这曲真好，我记下了。大叔*，我还有事，先告辞了。
        instruct_0();   --  0(0)::空语句(清屏)
    ...
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_1(3433,0,1);   --  1(1):[资差]说: ＜付出了就要有回报，虽然*少点，但也比没有强啊。＞*那我就不客气了。
    instruct_0();   --  0(0)::空语句(清屏)
